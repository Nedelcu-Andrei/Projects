...
icon = pygame.image.load(r'F:\IT\COD\PROIECTE\PACMAN\pacman_icon.jpg')
...
########### HELP FUNCTIONS ############
    ...
    def load(self):
        self.background = pygame.image.load(r'F:\IT\COD\PROIECTE\PACMAN\maze_image.png')
        self.background = pygame.transform.scale(self.background, (MAZE_WIDTH, MAZE_HEIGHT))
        
        
        # Opening walls.txt and creating walls list with their co-ords
        with open('F:\IT\COD\PROIECTE\PACMAN\walls.txt', 'r') as file:
    ...
    def draw_grid(self):
        ...
        for coin in self.coins:
            pygame.draw.rect(self.background, YELLOW, (coin.x*self.cell_width, coin.y*self.cell_height, self.cell_width, self.cell_height))
...
########### START MENU FUNCTIONS ############
    ...
    def start_draw(self):
        ...
        self.draw_text('1 PLAYER ONLY', self.screen, [WIDTH//2, HEIGHT//2+65], LOWER_TEXT_SIZE, (33, 137, 156), START_FONT, centered= True)
...
########### PLAYING FUNCTIONS ############
    ...
    def playing_draw(self):
        ...
        # self.draw_text('HIGH SCORE: 0', self.screen, [WIDTH//2+20,0], 18, WHITE, START_FONT)
        self.player.draw()
        for enemy in self.enemies:
            enemy.draw()
        pygame.display.update()
    ...
    def draw_coins(self):
        for coin in self.coins:
            pygame.draw.circle(self.screen, COINS, (int(coin.x*self.cell_width)+self.cell_width//2+TOP_BOTTOM_BUFFER//2, int(coin.y*self.cell_height)+self.cell_height//2+TOP_BOTTOM_BUFFER//2), 5)
