...
class Player:
    ...
    def update(self):
        ...
        # Setting grid position in reference to the pixel position
    ...
    def draw(self):
        ...
        for x in range(self.lives):
            pygame.draw.circle(self.app.screen, PLAYER_COLOUR, (30 + 20*x, HEIGHT - 15 ), 8)
        
        
        # Drawing the grid position of the rectangle
        ...
        if self.grid_pos in self.app.coins:
            ...
            if int(self.pix_pos.y + TOP_BOTTOM_BUFFER//2) % self.app.cell_height == 0:
                if self.direction == vec(0,1) or self.direction == vec(0,-1):
                     return True
        return False   
        # This part was copied from down below in order to make the coins dissapear the moment you touch them and not earlier
